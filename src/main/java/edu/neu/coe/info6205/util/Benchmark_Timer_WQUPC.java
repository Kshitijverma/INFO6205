 ...
 */
public class Benchmark_Timer_WQUPC<T> implements Benchmark<T> {
     ...
     */
    public Benchmark_Timer_WQUPC(String description, UnaryOperator<T> fPre, Consumer<T> fRun, Consumer<T> fPost) {
     ...
     *                    Function fRun is the function whose timing you want to measure. For example, you might create a function which sorts an array.
     */
    public Benchmark_Timer_WQUPC(String description, UnaryOperator<T> fPre, Consumer<T> fRun) {
     ...
     * @param fPost       a Consumer function (i.e. a function of T => Void).
     */
    public Benchmark_Timer_WQUPC(String description, Consumer<T> fRun, Consumer<T> fPost) {
     ...
     */
    public Benchmark_Timer_WQUPC(String description, Consumer<T> f) {
    ...
    final static LazyLogger logger = new LazyLogger(Benchmark_Timer_WQUPC.class);
}